...
namespace DVRSDK
{
    public class DHNetSDK
    {
        ...
        [DllImport(@"dhnetsdk.dll")]
        public static extern bool CLIENT_Init(fDisConnectCallBack cbDisConnect, IntPtr dwUser);
        ...
        [DllImport(@"dhnetsdk.dll")]
        public static extern bool CLIENT_CapturePicture(IntPtr hPlayHandle,
  string pchPicFileName, NET_CAPTURE_FORMATS eFormat);
        ...
        public static string GetErrorMessage<T>(T value)
            where T : struct
        {
            string result = "";
            object temp = value;
            ...
            if (isGetLastError)
            {
                ...
                if (0 != error)
                {
                    ...
                    result = "错误代码[" + error + "]：" + errorMessage;
                }
            }
