...
namespace DVRSDK
{
    ...
    public struct H264_DVR_DEVICEINFO
    {
        ...
        {
            status = new Int32[32];
            status[31] = XMNetSDK.g_config.nSDKType;
        }
    }
    ...
    public class XMNetSDK
    {
        public delegate void fDisConnect(Int32 lLoginID, string pchDVRIP, int nDVRPort, IntPtr dwUser);
        public delegate bool fMessCallBack(Int32 lLoginID, IntPtr pAlarm, uint dwBufLen, IntPtr dwUser);
        public delegate void fTransComCallBack(Int32 lLoginID, int lTransComType, StringBuilder pBuffer, uint dwBufSize, uint dwUser);
        public delegate void fDownLoadPosCallBack(Int32 lPlayHandle, int lTotalSize, int lDownLoadSize, int dwUser);
        public delegate void fPlayDrawCallBack(Int32 lPlayHand, IntPtr hDc, uint nUser);
        public delegate void fLocalPlayFileCallBack(Int32 lPlayHand, uint nUser);
        public delegate void InfoFramCallBack(Int32 lPlayHand, uint nType, string pBuf, uint nSize, uint nUser);
        public delegate int fRealDataCallBack_V2(Int32 lRealHandle, ref PACKET_INFO_EX pFrame, int dwUser);
        public delegate int fRealDataCallBack(Int32 lRealHandle, int dwDataType, string strBuf, int lbufsize, int dwUser);
        ...
        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_ClickKey(Int32 lLoginID, ref SDK_NetKeyBoardData pKeyBoardData);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_SendNetAlarmMsg(Int32 lLoginID, ref SDK_NetAlarmInfo pAlarmInfo);

        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_GetDevConfig(Int32 lLoginID, uint dwCommand, int nChannelNO, IntPtr bufptr, uint dwOutBufferSize, out uint lpBytesReturned, int waittime);
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_SetDevConfig(Int32 lLoginID, uint dwCommand, int nChannelNO, IntPtr bufptr, uint dwInBufferSize, int waittime);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_StopLocalRecord(Int32 lRealHandle);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_StartLocalRecord(Int32 lRealHandle, string szSaveFileName, int type);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_OpenSound(Int32 lHandle);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_LocalSetColor(Int32 lHandle, UInt32 nRegionNum, int nBrightness, int nContrast, int nSaturation, int nHue);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_LocalGetColor(Int32 lHandle, UInt32 nRegionNum, out int pBrightness, out int pContrast, out int pSaturation, out int pHue);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_MakeKeyFrame(Int32 lLoginID, int nChannel, int nStream);

        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_StopRealPlay(Int32 lLoginID, uint dwUser);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_CloseSound(Int32 lHandle);

        [DllImport(@"NetSdk.dll")]
        public static extern Int32 H264_DVR_RealPlay(Int32 lLoginID, ref H264_DVR_CLIENTINFO lpClientInfo);
        ...
        [DllImport(@"NetSdk.dll")]
        public static extern Int32 H264_DVR_Logout(Int32 lLoginID);//登出设备
        [DllImport(@"NetSdk.dll")]
        ...
        [DllImport(@"NetSdk.dll")]
        public static extern Int32 H264_DVR_StartLocalVoiceCom(Int32 lLoginID);
        ...
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_SetupAlarmChan(Int32 lLoginID);

        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_CloseAlarmChan(Int32 lLoginID);

        // 播放本地文件
        [DllImport(@"NetSdk.dll")]
        public static extern Int32 H264_DVR_StartLocalPlay(string pFileName, IntPtr hWnd, fPlayDrawCallBack drawCallBack, uint user);
        ...
        //获取播放位置用于回放，和本地播放
        [DllImport(@"NetSdk.dll")]
        public static extern float H264_DVR_GetPlayPos(Int32 lPlayHandle);
        //设置播放位置（百分比）用于回放，和本地播放
        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_SetPlayPos(Int32 lPlayHandle, float fRelativPos);
        //播放控制（播放，停止，恢复，快发，慢放）
        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_LocalPlayCtrl(Int32 lPlayHandle, SDK_LoalPlayAction action, uint lCtrlValue);
        //设置播放结束回调
        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_SetFileEndCallBack(Int32 lPlayHandle, fLocalPlayFileCallBack callBack, IntPtr user);
        //设置信息帧回调
        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_SetInfoFrameCallBack(Int32 lPlayHandle, InfoFramCallBack callback, uint user);
        ...
        //waittime		查询超时时间
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_FindFile(Int32 lLoginID, ref H264_DVR_FINDINFO lpFindInfo, IntPtr ptr, int lMaxCount, out int findcount, int waittime);
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_GetFileByName(Int32 lLoginID, ref H264_DVR_FILE_DATA sPlayBackFile, string sSavedFileName,
                                            fDownLoadPosCallBack cbDownLoadPos, int dwDataUser, fRealDataCallBack fDownLoadDataCallBack);
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_GetFileByTime(Int32 lLoginID, ref H264_DVR_FINDINFO lpFindInfo, string sSavedFileDIR, bool bMerge,
                                            fDownLoadPosCallBack cbDownLoadPos, int dwDataUser, fRealDataCallBack fDownLoadDataCallBack);
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_PlayBackByName_V2(Int32 lLoginID, ref H264_DVR_FILE_DATA sPlayBackFile, fDownLoadPosCallBack cbDownLoadPos, fRealDataCallBack_V2 fDownLoadDataCallBack, int dwDataUser);
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_PlayBackByTimeEx(Int32 lLoginID, ref H264_DVR_FINDINFO lpFindInfo, fRealDataCallBack fDownLoadDataCallBack, int dwDataUser,
                                            fDownLoadPosCallBack cbDownLoadPos, int dwPosUser);
        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_PlayBackControl(Int32 lPlayHandle, int lControlCode, int lCtrlValue);
        [DllImport(@"NetSdk.dll")]
        ...
        [DllImport(@"NetSdk.dll")]
        public static extern int H264_DVR_GetDownloadPos(Int32 lFileHandle);

        [DllImport(@"NetSdk.dll")]
        //抓本地图片 //预览，回放，本地播放 一个函数
        public static extern bool H264_DVR_LocalCatchPic(Int32 lHandle, string strPath);

        [DllImport(@"NetSdk.dll")]
        public static extern bool H264_DVR_PTZControl(Int32 lLoginID, int nChannelNo, int lPTZCommand, bool bStop, long lSpeed);


        [DllImport(@"H264Play.dll")]
        public static extern bool H264_PLAY_CatchPic(Int32 Channel, string szSaveFileName, int ntype = 0);
